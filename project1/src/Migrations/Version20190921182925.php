 ...
 */
final class Version20190921182925 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE garmin_activity_details (activity_id BIGINT NOT NULL, activity_uuid VARCHAR(255) DEFAULT NULL, activity_name VARCHAR(255) DEFAULT NULL, user_profile_id BIGINT DEFAULT NULL, is_multi_sport_parent BOOLEAN DEFAULT NULL, activity_type_id INT DEFAULT NULL, activity_type_key VARCHAR(255) DEFAULT NULL, is_original BOOLEAN DEFAULT NULL, associated_workout_id BIGINT DEFAULT NULL, elevation_corrected BOOLEAN DEFAULT NULL, start_latitude DOUBLE PRECISION DEFAULT NULL, start_longitude DOUBLE PRECISION DEFAULT NULL, distance DOUBLE PRECISION DEFAULT NULL, duration DOUBLE PRECISION DEFAULT NULL, moving_duration DOUBLE PRECISION DEFAULT NULL, elapsed_duration DOUBLE PRECISION DEFAULT NULL, elevation_gain DOUBLE PRECISION DEFAULT NULL, elevation_loss DOUBLE PRECISION DEFAULT NULL, max_elevation DOUBLE PRECISION DEFAULT NULL, min_elevation DOUBLE PRECISION DEFAULT NULL, average_speed DOUBLE PRECISION DEFAULT NULL, average_moving_speed DOUBLE PRECISION DEFAULT NULL, max_speed DOUBLE PRECISION DEFAULT NULL, calories DOUBLE PRECISION DEFAULT NULL, average_hr DOUBLE PRECISION DEFAULT NULL, max_hr DOUBLE PRECISION DEFAULT NULL, average_run_cadence DOUBLE PRECISION DEFAULT NULL, max_run_cadence DOUBLE PRECISION DEFAULT NULL, average_temperature DOUBLE PRECISION DEFAULT NULL, max_temperature DOUBLE PRECISION DEFAULT NULL, min_temperature DOUBLE PRECISION DEFAULT NULL, ground_contact_time DOUBLE PRECISION DEFAULT NULL, ground_contact_balance_left DOUBLE PRECISION DEFAULT NULL, stride_length DOUBLE PRECISION DEFAULT NULL, vertical_oscillation DOUBLE PRECISION DEFAULT NULL, training_effect DOUBLE PRECISION DEFAULT NULL, vertical_ratio DOUBLE PRECISION DEFAULT NULL, lactate_threshold_speed DOUBLE PRECISION DEFAULT NULL, end_latitude DOUBLE PRECISION DEFAULT NULL, end_longitude DOUBLE PRECISION DEFAULT NULL, start_time_local TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, start_time_gmt TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, user_display_name VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, activity_parent_type_id INT DEFAULT NULL, comments VARCHAR(255) DEFAULT NULL, owner_full_name VARCHAR(255) DEFAULT NULL, average_swolf DOUBLE PRECISION DEFAULT NULL, steps INT DEFAULT NULL, number_of_activity_likes INT DEFAULT NULL, training_effect_anaerobic DOUBLE PRECISION DEFAULT NULL, v_o2max_value DOUBLE PRECISION DEFAULT NULL, avg_ground_contact_balance DOUBLE PRECISION DEFAULT NULL, lactate_threshold_bpm DOUBLE PRECISION DEFAULT NULL, device_id DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(activity_id))');
